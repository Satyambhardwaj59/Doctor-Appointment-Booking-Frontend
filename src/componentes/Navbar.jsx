...
const Navbar = () => {
  ...
  return (
    <div className='flex items-center justify-between text-sm py-4 mb-5 border-b border-gray-400'>
        <img onClick={() => navigate('/')} className='w-44 h-16 cursor-pointer' src={assets.logo_one} alt="" />
        ...
        <div className='flex items-center gap-4'>
            {
                ...
                : <button onClick={() => navigate('/login')} className='bg-indigo-600 text-white px-8 py-3 rounded-full font-light hidden md:block cursor-pointer'>Create account</button>
            }
